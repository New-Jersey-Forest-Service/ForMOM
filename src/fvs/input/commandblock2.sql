---
--- Doing the 167N 167S Split
---

-- UPDATE FVS_STANDINIT_PLOT_20152019T
-- SET STAND_ID = '167N'
-- WHERE
-- 	COUNTY IN (5, 23, 25, 29) AND
-- 	STAND_ID = 167;

-- UPDATE FVS_STANDINIT_PLOT_20152019T
-- SET STAND_ID = '167S'
-- WHERE
-- 	COUNTY IN (1, 7, 11, 15, 19) AND
-- 	STAND_ID = 167;


-- UPDATE FVS_STANDINIT_PLOT
-- SET STAND_ID = '167N'
-- WHERE
-- 	COUNTY IN (5, 23, 25, 29) AND
-- 	STAND_ID = 167;
...
FROM FVS_STANDINIT_PLOT_20152019T
GROUP BY STAND_ID;
...
FROM FVS_TREEINIT_PLOT_20152019T AS TREEINIT
...
--
-- Edits to TREEINIT_20152019T & PLOTINIT_20152019T
--
...
-- Renaming FVS_PLOTINIT_PLOT_20152019T -> FVS_PLOTINIT_PLOT
ALTER TABLE FVS_PLOTINIT_PLOT
RENAME TO FVS_PLOTINIT_PLOT_BU;

ALTER TABLE FVS_PLOTINIT_PLOT_20152019T
RENAME TO FVS_PLOTINIT_PLOT;

-- Renaming FVS_TREEINIT_PLOT_20152019T -> FVS_TREEINIT_PLOT
